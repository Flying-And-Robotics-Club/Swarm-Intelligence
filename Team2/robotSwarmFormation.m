...
%%%%%%%%%%%%%
outpath = pwd;
outputVideo = VideoWriter(fullfile(outpath,'ModSimulationVideo.mp4'),'MPEG-4');
open(outputVideo);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function bots = distributeBots(N)
        ...
        while(randLoop)
            ...
            A = normrnd(29.7857,14.2047,[2,N]);
            %A = [ 42.7658 55.0322 28.7806 21.2020 30.3205 22.9783 40.0787  62.6628; 24.9648 13.6587 16.2474 22.9265 32.1002 10.8159 27.6475 24.3894]
